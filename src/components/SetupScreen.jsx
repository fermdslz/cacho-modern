...
const SetupScreen = ({ tempNames, setTempNames, onStart, onShowChangelog, onShowSettings }) => {
    ...
    return (
        <div className="p-4 max-w-md mx-auto w-full overflow-x-hidden">
...
const PlayerRow = ({ player, index, updateName, removePlayer }) => {
    ...
    return (
        ...
        >
            ...
            <input
                className="flex-1 paper-cell p-3 h-[50px] rounded-lg font-bold text-table-ink focus:outline-none focus:ring-4 focus:ring-table-green/30 transition-all placeholder-gray-400 min-w-0"
